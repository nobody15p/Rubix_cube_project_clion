...
#ifndef RUBIX_CUBE_PROJECT_CLION_GENERICRUBIKSCUBE_H
#define RUBIX_CUBE_PROJECT_CLION_GENERICRUBIKSCUBE_H
...
public:
    ...
    enum class MOVE {
        // Rubik's Cube moves, rotations
        // left clockwise, left anticlockwise, left twice ...
        L, LPRIME, L2,
        R, RPRIME, R2,
        U, UPRIME, U2,
        D, DPRIME, D2,
    ...
    /*
     * pure virtual function written below
    ...
    /*
     * Print function given below will be used to print Rubik's Cube
    ...
    /*
     * function given below used for shuffling cube which is solvable
     * Randomly shuffle the cube with 'times' moves and returns the moves performed.
     */
    vector<MOVE> randomShuffleCube(unsigned int times);

    /*
     * function given below takes input a move and performs it on Rubik's Cube
     * Perform moves on the Rubik's Cube
     */
    GenericRubiksCube &move(MOVE ind);

    /*
     * revert a move back or undo
     * Invert a move
     */
    GenericRubiksCube &invert(MOVE ind);

    /*
     * Given below are pure virtual functions for each of 18 moves
...
#endif //RUBIX_CUBE_PROJECT_CLION_GENERICRUBIKSCUBE_H
